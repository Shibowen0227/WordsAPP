package com.Shibunny.shi.bo.wen.wordsAPP.wordcontract;
...
public class Words {
    ...
    public static final String AUTHORITY = "shibunny";//URI授权者

    public Words() {
    }

    //注意，接口BaseColumns接口有一个字段为"_ID",该字段对于ContentProvider非常重要
    // Word表共4个字段：_ID、word、meaning、sample
    public static abstract class Word implements BaseColumns {
        ...
        //MIME类型
        public static final String MIME_DIR_PREFIX = "sbw.android.cursor.dir";
        public static final String MIME_ITEM_PREFIX = "sbw.android.cursor.item";
        public static final String MINE_ITEM = "sbw.shibunny.shi.bo.wen.word";
